...
const handler: Handler = async () => {
    try{
        ...
        const appeals = (await axios.post(`https://api.thegraph.com/subgraphs/name/klerosboard/klerosboard-gnosis`,    
        ...
        for(const appeal of appeals){
            ...
            const response = (await axios.post('https://api.thegraph.com/subgraphs/name/andreimvp/kleros-display',    
            ...
            await axios.post(`https://api.telegram.org/bot${process.env.BOT_TOKEN}/sendMessage`, {
                ...
                text: `[Dispute ${appeal.disputeID}](https://court.kleros.io/cases/${appeal.disputeID}) on Gnosis concluded it's current round!
...
Appeals can be [requested]${isReality? `(https://resolve.kleros.io/cases/${appeal.disputeID})` : `(https://court.kleros.io/cases/${appeal.disputeID})`}. View votes on [KlerosBoard](https://klerosboard.com/100/cases/${appeal.disputeID})`,
        ...
        await datalake.from(`bot-block-heights`).update({timestamp: startTimeMax}).eq("bot_name", `tg-court-functions-appeal-possible`).eq("network", "gnosis")
